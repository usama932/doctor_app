				...
				<nav class="navbar navbar-expand-lg header-nav no-border">
					...
					<div class="main-menu-wrapper">
						...
						<li class="has-submenu <?php if($page=="index" || $page=="index-1" || $page=="index-2" || $page=="index-3" || $page=="index-5"|| $page=="index-4" || $page=="index-6" || $page=="index-7" || $page=="index-8" || $page=="index-9" || $page=="index-10" || $page=="index-11" || $page=="index-12" || $page=="index-13" || $page=="index-14") { echo 'active'; } ?>">
	                            ...
	                            <li class="has-submenu <?php if($page=="voice-call" || $page=="video-call" || $page=="onboarding-email" || $page=="patient-email" || $page=="search" || $page=="calendar" || $page=="components" || $page=="invoices1" || $page=="invoice-view" || $page=="blank-page" || $page=="login" || $page=="register1" || $page=="forgot-pswd" || $page=="about-us" || $page=="contact-us") { echo 'active'; } ?>">
	                       ...
	                       <li class="has-submenu <?php if($page=="index_admin" || $page=="index_pharmacy_admin") { echo 'active'; } ?>">
	                        	<a href="#" target="_blank">Admin <i class="fas fa-chevron-down"></i></a>
	                       		<ul class="submenu">
									<li class="<?php if($page=="index_admin") { echo 'active'; } ?>"><a href="{{url('admin/login')}}" target="_blank">Admin</a></li>
									<li class="<?php if($page=="index_pharmacy_admin") { echo 'active'; } ?>"><a href="{{url('pharmacy-admin/login')}}" target="_blank">Pharmacy Admin</a></li>
								</ul>
	                        </li>
							<li class="login-link">
					...
					<ul class="nav header-navbar-rht right-menu">
								<li class="nav-item">
									<a class="nav-link btn-two rounded-pill" href="{{url('login')}}">
