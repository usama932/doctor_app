                    ...
                    @auth
                        <li class="nav-item dropdown has-arrow logged-item">
                            <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                                <span class="user-img">
                                    <img class="rounded-circle" src="{{ asset_img('hospitals', auth()->user()->profile_image) }}" width="31">
                                </span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="user-header">
                                    <div class="avatar avatar-sm">
                                        <img src="{{ asset_img('hospitals', auth()->user()->profile_image) }}" alt="User Image"
                                ...
                                <a class="dropdown-item" href="{{ route('hospital.edit.profile') }}">Profile</a>
                                <a
