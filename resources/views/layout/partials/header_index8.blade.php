				...
				<nav class="navbar navbar-expand-lg header-nav">
					...
					<div class="main-menu-wrapper">
						...
						<ul class="main-nav">
							...
							<li class="has-submenu <?php if($page=="voice-call" || $page=="video-call" || $page=="search" || $page=="onboarding-email" || $page=="patient-email" || $page=="calendar" || $page=="components" || $page=="invoices1" || $page=="invoice-view" || $page=="blank-page" || $page=="about-us" || $page=="contact-us" || $page=="login" || $page=="register1" || $page=="forgot-pswd") { echo 'active'; } ?>">
							...
							<li class="nav-item">
								<a class="nav-link header-login" href="{{url('login')}}"><i class="fas fa-user-circle"></i> login / Signup </a>
							</li>
						</ul>		 
					</div>	
				</nav>
