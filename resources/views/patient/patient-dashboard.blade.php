                            ...
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 patient-dashboard-top">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <div class="mb-3">
                                            <img
                                                src="{{ URL::asset('/assets/img/specialities/pt-dashboard-01.png')}}"
                                                alt="" width="55">
                                        </div>
                                        <h5>Heart Rate</h5>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 patient-dashboard-top">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <div class="mb-3">
                                            <img
                                                src="{{ URL::asset('/assets/img/specialities/pt-dashboard-02.png')}}"
                                                alt="" width="55">
                                        </div>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 patient-dashboard-top">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <div class="mb-3">
                                            <img
                                                src="{{ URL::asset('/assets/img/specialities/pt-dashboard-03.png')}}"
                                                alt="" width="55">
                                        </div>
                                        <h5>Glucose Level</h5>
                                        <h6>70 - 90</h6>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 patient-dashboard-top">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <div class="mb-3">
                                            <img
                                                src="{{ URL::asset('/assets/img/specialities/pt-dashboard-04.png')}}"
                                                alt="" width="55">
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 patient-graph-box">
                                                <a href="#" class="graph-box">
                                                    ...
                                                    <div class="graph-img">
                                                        <img
                                                            src="{{ URL::asset('/assets/img/shapes/graph-01.png')}}"
                                                            alt="">
                                                    </div>
                                                    <div class="graph-status-result mt-3">
                                                        <h3 class="bmi_data_last"></h3>
                                                        <span class="graph-update-date">{{$appointments->count()}}</span>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 patient-graph-box">
                                                <a href="#" class="graph-box pink-graph">
                                                    ...
                                                    <div class="graph-img">
                                                        <img
                                                            src="{{ URL::asset('/assets/img/shapes/graph-02.png')}}"
                                                            alt="">
                                                    </div>
                                                    <div class="graph-status-result mt-3">
                                                        <h3 class="bmi_data_last"></h3>
                                                        <span class="graph-update-date">{{ $upcommingAppointments->count() }}</span>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 patient-graph-box">
                                                <a href="#" class="graph-box sky-blue-graph">
                                                    ...
                                                    <div class="graph-img">
                                                        <img
                                                            src="{{ URL::asset('/assets/img/shapes/graph-03.png')}}"
                                                            alt="">
                                                    </div>
                                                    <div class="graph-status-result mt-3">
                                                        <h3 class="bmi_data_last"></h3>
                                                        <span class="graph-update-date">{{ $confirmedAppointments->count() }}</span>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 patient-graph-box">
                                                <a href="#" class="graph-box orange-graph">
                                                    ...
                                                    <div class="graph-img">
                                                        <img
                                                            src="{{ URL::asset('/assets/img/shapes/graph-04.png')}}"
                                                            alt="">
                                                    </div>
                                                    <div class="graph-status-result mt-3">
                                                        <h3 class="bmi_data_last"></h3>
                                                        <span class="graph-update-date">${{ number_format($totalSpent, 2) }}</span>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="{{url('#pat_appointments')}}"
                                               data-bs-toggle="tab">Upcomming Appointments</a>
                                        </li>
                                        {{-- <li class="nav-item">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <h2 class="table-avatar">
                                                                            <a href="{{route('doctor_profile', $appointment->doctor_id)}}"
                                                                            class="avatar avatar-sm me-2">
                                                                                <img class="avatar-img rounded-circle"
                                                                                    src="{{ asset_img("doctors", $doctor->profile_image)}}">
                                                                            </a>
                                                                            <a href="{{route('doctor_profile', $appointment->doctor_id)}}">Dr. {{$doctor->name}}
                                                                                <span>{{$doctor->speciality->name}}</span></a>
                                                                        </h2>
                                                                    </td>
                                                                    <td>
                                                                        {{date("F d, Y", strtotime($appointment->appointment_date))}}
                                                                        <span class="d-block text-info">{{date("h:m A", strtotime($appointment->appointment_date . $appointment->appointment_time))}}</span>
                                                                    </td>
                                                                    <td>{{date("F d, Y", strtotime($appointment->created_at))}}</td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        @endphp
                                                                        <span class="badge badge-pill {{$bg}}">{{$statusTxt}} - {{$appointment->payment_status}}</span>
                                                                    </td>
                                                                    <td class="text-end">
                                                                        <div class="table-action">
                                                                            ...
                                                                            <a href="{{ route('show_invoice', $appointment->id) }}"
