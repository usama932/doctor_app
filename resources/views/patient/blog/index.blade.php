            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-12">
                        ...
                        <div class="blog">
                            <div class="blog-image">
                                <a href="{{ route('blog_details') }}">
                                    <img class="img-fluid" src="{{ asset_img('blogs')}}" >
                                </a>
                            </div>
                            <h3 class="blog-title"><a href="{{ route('blog_details') }}">Doccure – Making your
                        ...
                        <div class="blog">
                            <div class="blog-image">
                                <a href="{{ route('blog_details') }}"><img class="img-fluid"
                                                                           src="{{ URL::asset('/assets/img/blog/blog-02.jpg')}}"
                                                                           alt=""></a>
                            </div>
                            <h3 class="blog-title"><a href="{{ route('blog_details') }}">What are the benefits
                                    of Online Doctor Booking?</a></h3>
                            <div class="blog-info clearfix">
                                <div class="post-left">
                                    <ul>
                                        <li>
                        ...
                        <div class="blog">
                            ...
                            <h3 class="blog-title"><a href="{{ route('blog_details') }}">Benefits of consulting
                        ...
                        <div class="blog">
                            <div class="blog-image">
                                <div class="video">
                                    <iframe src="https://player.vimeo.com/video/133170635"
                                            width="940"></iframe>
                                </div>
                            </div>
                            <h3 class="blog-title"><a href="{{ route('blog_details') }}">5 Great reasons to use
                            ...
                            <div class="card-body">
                                <ul class="latest-posts">
                                    <li>
                                        ...
                                        <div class="post-info">
                                            <h4>
                                                <a href="{{ route('blog_details') }}">Doccure – Making your
                                                    clinic painless visit?</a>
                                            </h4>
                                            <p>4 Dec 2019</p>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="post-info">
                                            <h4>
                                                <a href="{{ route('blog_details') }}">What are the benefits of
                                                    Online Doctor Booking?</a>
                                            </h4>
                                            <p>3 Dec 2019</p>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="post-info">
                                            <h4>
                                                <a href="{{ route('blog_details') }}">Benefits of consulting
                                                    with an Online Doctor</a>
                                            </h4>
                                            <p>3 Dec 2019</p>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="post-info">
                                            <h4>
                                                <a href="{{ route('blog_details') }}">5 Great reasons to use an
                                                    Online Doctor</a>
                                            </h4>
                                            <p>2 Dec 2019</p>
                                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="post-info">
                                            <h4>
                                                <a href="{{ route('blog_details') }}">Online Doctor Appointment
                                                    Scheduling</a>
                                            </h4>
                                            <p>1 Dec 2019</p>
                                        </div>
