                                ...
                                <ul class="latest-posts">
                                    <li>
                                        <div class="post-thumb">
                                            <a href="{{ route('blog_details') }}">
                                                <img class="img-fluid"
                                                     src="{{ URL::asset('/assets/img/blog/blog-thumb-01.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="post-info">
                                            <h4>
                                                <a href="{{ route('blog_details') }}">Doccure – Making your clinic
                                                    painless
                                                    visit?</a>
                                            </h4>
                                            <p>4 Dec 2019</p>
                                    ...
                                    <li>
                                        <div class="post-thumb">
                                            <a href="{{ route('blog_details') }}">
                                                <img class="img-fluid"
                                                     src="{{ URL::asset('/assets/img/blog/blog-thumb-02.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="post-info">
                                            <h4>
                                                <a href="{{ route('blog_details') }}">What are the benefits of Online
                                                    Doctor
                                                    Booking?</a>
                                            </h4>
                                            <p>3 Dec 2019</p>
                                    ...
                                    <li>
                                        <div class="post-thumb">
                                            <a href="{{ route('blog_details') }}">
                                                <img class="img-fluid"
                                                     src="{{ URL::asset('/assets/img/blog/blog-thumb-03.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="post-info">
                                            <h4>
                                                <a href="{{ route('blog_details') }}">Benefits of consulting with an
                                                    Online
                                                    Doctor</a>
                                            </h4>
                                            <p>3 Dec 2019</p>
                                    ...
                                    <li>
                                        <div class="post-thumb">
                                            <a href="{{ route('blog_details') }}">
                                                <img class="img-fluid"
                                                     src="{{ URL::asset('/assets/img/blog/blog-thumb-04.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="post-info">
                                            <h4>
                                                <a href="{{ route('blog_details') }}">5 Great reasons to use an Online
                                                    Doctor</a>
                                            </h4>
                                            <p>2 Dec 2019</p>
                                        </div>
                                    ...
                                    <li>
                                        <div class="post-thumb">
                                            <a href="{{ route('blog_details') }}">
                                                <img class="img-fluid"
                                                     src="{{ URL::asset('/assets/img/blog/blog-thumb-05.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="post-info">
                                            <h4>
