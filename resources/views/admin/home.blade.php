                        ...
                        <a href="{{ route('appointments') }}" class="card-body">
                            <div class="dash-widget-header">
										<span class="dash-widget-icon bg-warning">
											<img src="{{ URL::asset('/assets_admin/img/icon/calendar.png')}}"
                                                 alt="User Image">
										</span>
                                <div class="dash-count">
                        ...
                        <div class="card-body">
                            <div class="dash-widget-header">
										<span class="dash-widget-icon bg-danger">
											<img src="{{ URL::asset('/assets_admin/img/icon/chart.png')}}"
                                                 alt="User Image">
										</span>
                                <div class="dash-count">
                            ...
                            <div class="item">
                                <div class="appointment-item">
                                    <div class="app-head">
                                        ...
                                        {{-- <div class="con-time"></div> --}}
                                    </div>
                                    <div class="app-user">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="app-img">
                                                    <img src="{{ asset_img('doctors', $appointment->doctor?$appointment->doctor->profile_image:'')}}"
                                                        alt="" class="img-fluid">
                                                    <div class="app-name">
                                                        <h6>Dr. {{$appointment->doctor?$appointment->doctor->name:''}}</h6>
                                                        @if ($appointment->doctor)
                                                            <p>{{$appointment->doctor->speciality ? $appointment->doctor->speciality->name:''}}</p>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="app-img justify-content-sm-end">
                                                    <img src="{{ asset_img('patients', $appointment->patient?$appointment->patient->profile_image:'')}}"
                                                        alt="" class="img-fluid">
                                                    <div class="app-name">
                                                        <h6>{{$appointment->patient?$appointment->patient->name:''}}</h6>
                                                        <p>ID : {{$appointment->patient?$appointment->patient->id:''}}, {{$appointment->patient?$appointment->patient->gender:''}}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="app-info">
                                        ...
                                        <div>
                                            <p>Booked on</p>
                                            <h6 class="fw-normal">{{ date('d/m/Y h:i A', strtotime($appointment->created_at)) }}</h6>
                                        </div>
                                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-borderless hover-table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{url('admin/profile')}}"><img class="avatar avatar-img"
                                        ...
                                        <td><span class="badge bg-badge-grey text-success"><i
                                                    class="fas fa-circle me-1"></i> Enabled</span></td>
                                        <td class="text-right">
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge bg-badge-grey text-danger"><i
                                                    class="fas fa-circle me-1"></i> Disabled</span></td>
                                        <td class="text-right">
                                            <i class="feather-chevron-right"></i>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{url('admin/profile')}}"><img class="avatar avatar-img"
                                                                                        src="{{ URL::asset('/assets_admin/img/profiles/avatar-05.jpg')}}"
                                                                                        alt="User Image"></a>
                            ...
                            <div class="table-responsive">
                                <table class="table doc-table">
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a class="avatar-pos avatar-online" href="{{url('admin/profile')}}"><img
                                                        class="avatar avatar-img"
                                                        src="{{ URL::asset('/assets_admin/img/profiles/avatar-05.jpg')}}"
                                                        alt="User Image"></a>
                                                <a href="#" class="user-name"><span class="text-muted">Dr. Rayan</span>
                                        ...
                                        <td>
                                            <h2 class="table-avatar">
                                                <a class="avatar-pos avatar-online" href="{{url('admin/profile')}}"><img
                                                        ...
                                                        alt="User Image"></a>
                                                <a href="#" class="user-name"><span class="text-muted">Dr. Bea</span>
                                                    <span class="tab-subtext">Dentist</span></a>
                                            </h2>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a class="avatar-pos avatar-offline"
                                                   href="{{url('admin/profile')}}"><img class="avatar avatar-img"
                                                                                        src="{{ URL::asset('/assets_admin/img/profiles/avatar-11.jpg')}}"
                                                                                        alt="User Image"></a>
                                                <a href="#" class="user-name"><span class="text-muted">Dr. Monroe</span>
                                                    <span class="tab-subtext">Hair Specialities</span></a>
                                            </h2>
                                        </td>
                                            ...
                                            <h2 class="table-avatar">
                                                <a class="avatar-pos avatar-offline"
                                                   href="{{url('admin/profile')}}"><img class="avatar avatar-img"
                                                                                        ...
                                                                                        alt="User Image"></a>
                                                <a href="#" class="user-name"><span class="text-muted">Dr. Lester</span>
                                                    <span class="tab-subtext">Orthopaedics</span></a>
                                            </h2>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a class="empty-user" href="{{url('admin/profile')}}"><i
                                                        class="feather-user"></i> </a>
                                                <a href="#" class="user-name"><span class="text-muted">Dr. Clint</span>
                                                    <span class="tab-subtext">Neurology</span></a>
                                            </h2>
                                        </td>
                            ...
                            <div class="table-responsive">
                                <table class="table table-borderless">
                                    ...
                                    <tr class="speciality-item">
                                        <td class="spl-name">
                                            <div class="spl-box">
                                                <img src="{{ URL::asset('/assets_admin/img/icon/urology.png')}}"
                                                     alt="User Image">
                                            </div>
                                            <div class="spl-count">
                                                <h6>Urology</h6>
                                        ...
                                        <div class="app-user">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="app-img">
                                                        <img
                                                            src="{{ URL::asset('/assets_admin/img/profiles/avatar-09.jpg')}}"
                                                            alt="" class="img-fluid">
                                                        <div class="app-name">
                                                            <h6>Dr. Rayan </h6>
                                                            <p>Orthopaedics</p>
                                        ...
                                        <div class="app-user">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="app-img">
                                                        <img
                                                            src="{{ URL::asset('/assets_admin/img/profiles/avatar-08.jpg')}}"
                                                            alt="" class="img-fluid">
                                                        <div class="app-name">
                                                            <h6>Dr. Leo </h6>
                                                            <p>Orthopaedics</p>
